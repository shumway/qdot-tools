...
void LatticeIndexingH5::h5Write(const std::string& filename, 
  ...
  hid_t grpID = H5Gcreate2(fileID,"latticeIndexing", H5P_DEFAULT,
...
#if (H5_VERS_MAJOR>1)||((H5_VERS_MAJOR==1)&&(H5_VERS_MINOR>=8))
  hid_t attrID = H5Acreate(grpID,"primativeAtomOffsets",H5T_NATIVE_FLOAT,
                           aspaceID,H5P_DEFAULT,H5P_DEFAULT);
#else
...
#if (H5_VERS_MAJOR>1)||((H5_VERS_MAJOR==1)&&(H5_VERS_MINOR>=8))
  hid_t dsetID = H5Dcreate2(grpID, "index",
