...
#else
  H5Awrite(attrID,H5T_NATIVE_DOUBLE,(Vec3*)&a1);
#endif
  H5Aclose(attrID);
...
#else
  H5Awrite(attrID,H5T_NATIVE_DOUBLE,(Vec3*)&a2);
#endif
  H5Aclose(attrID);
...
#else
  H5Awrite(attrID,H5T_NATIVE_DOUBLE,(Vec3*)&a3);
#endif
  H5Aclose(attrID);
  H5Sclose(aspaceID);}
...
#else
  H5Awrite(attrID,H5T_NATIVE_DOUBLE,(Vec3*)&offset[0]);
#endif
  H5Aclose(attrID);
  H5Sclose(aspaceID);}
